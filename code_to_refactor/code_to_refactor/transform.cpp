...
transform::transform(const BasicShape& sh)
{
	shape = sh;
}

BasicShape transform::shift(int m, int n, int k)
{
...
BasicShape transform::scaleX(int a)
{
	switch (shape.getType())
	{
	case BasicShape::line:
...
BasicShape transform::scaleY(int d)
{
	switch (shape.getType())
	{
	case BasicShape::line:
...
BasicShape transform::scaleZ(int e)
{
	switch (shape.getType())
	{
	case BasicShape::line:
...
BasicShape transform::scale(int s)
{
	switch (shape.getType())
	{
	case BasicShape::line:
